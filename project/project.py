...
nameList = ["sabina","rony","love","sabron"]

def name_game (name) :

    com_choice = random.choice(nameList)

    if com_choice == name :
        print("You win")
    else :
        print("computer name choice :",com_choice)
        print("you choice :",name)
        print("you loss")


print("sabina,rony,sabron,love")

name = input("your name choice : ")
name_game(name)
